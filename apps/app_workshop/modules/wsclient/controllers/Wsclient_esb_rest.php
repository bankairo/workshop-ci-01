...
class wsclient_esb_rest extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->set_template_html_title('Workshop: Web Application Development - REST WS Client (via ESB)');
        
        $this->load->helper(array('form'));
        $this->load->library(array('form_validation'));
        
        $this->load->model('wsclient/wsclient_esb_rest_model', 'wsclient');
    }
    ...
    function index() {
        ...
        $this->_view_data['_data_count'] = $ws_data->PersonListParam->PersonListCounts->PersonListCount;
        $this->_view_data['_data_list'] = $ws_data->PersonListParam->PersonListDatas->PersonListData;
        
        $this->init_pagination($_config_page['url'], $this->_view_data['_data_count']->data_count, TRUE, $params['offset']);
        
        $p_js = $this->load->view('wsclient/rest_esb/person_view_js',array(),true);
        $this->add_template_html_footer($p_js);
                
        $this->load_view('wsclient/rest_esb/person_list', $this->_view_data);
    }
    
    function ajax_edit($id){
        $data = $this->wsclient->person_view_by_id($id);
        //var_dump($data);
        $data = $data->PersonView;
