...
class wsclient_rest extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->set_template_html_title('Workshop: Web Application Development - REST WS Client');
        
        
        $this->load->helper(array('form'));
        $this->load->library(array('form_validation'));
        
        $this->load->model('wsclient/wsclient_rest_model', 'wsclient');
    }
    ...
    function index() {
        ...
        $p_js = $this->load->view('wsclient/rest/person_view_js',array(),true);
        $this->add_template_html_footer($p_js);
                
        $this->load_view('wsclient/rest/person_list', $this->_view_data);
    }
