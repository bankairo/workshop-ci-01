...
class wsclient_esb_rest_model extends CI_Model {
    ...
    function __construct() {
        ...
        $this->_url = 'https://localhost:8243/services/workshop.workshopHttpsEndpoint/';
        
        $this->_curl_username = 'workshop';
        $this->_curl_password = 'workshop';
    ...
    private function _call_rest($method, $operation, $data = array()) {
        ...
        if ($this->_curl_username != ''){
            curl_setopt($_curl, CURLOPT_USERPWD, $this->_curl_username . ":" . $this->_curl_password);
        }
